...
public class PeliculaLogic {
   ...
   public PeliculaEntity createPelicula(PeliculaEntity pelicula)throws BusinessLogicException{
   ...
   public PeliculaEntity findById(long id)throws WebApplicationException{
